...
func Routing() {
	...
	http.HandleFunc("/getnursesanddepartments", getDepartmentsAndNursesDropdownDataByFacility)
	http.HandleFunc("/getnursestasksandstats", getNursesTasksAndStatsDataByNurseId)
